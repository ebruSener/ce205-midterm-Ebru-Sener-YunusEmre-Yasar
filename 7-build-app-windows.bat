...
call reportgenerator "-title:Schoolsystem Library Documentation Coverage Report (Windows)" "-reports:**/lcov_doxygen_lib_win.info" "-targetdir:docs/coverxygenlibwin" "-reporttypes:Html" "-filefilters:-*.md;-*.xml;-*[generated];-*build*" "-historydir:report_doc_lib_hist_win"
...
call reportgenerator "-title:Schoolsystem Library Test Documentation Coverage Report (Windows)" "-reports:**/lcov_doxygen_test_win.info" "-targetdir:docs/coverxygentestwin" "-reporttypes:Html" "-filefilters:-*.md;-*.xml;-*[generated];-*build*" "-historydir:report_doc_test_hist_win"
...
echo Generate Test Coverage Data for Schoolsystem
call OpenCppCoverage.exe --export_type=binary:schoolsystem_tests_unit_win.cov --sources src\schoolsystem\src --sources src\schoolsystem\header --sources src\tests\schoolsystem -- build_win\build\Debug\schoolsystem_tests.exe

echo Generate Test Coverage Data for Schoolsystem App and Combine Results
call OpenCppCoverage.exe --input_coverage=utility_tests_unit_win.cov --input_coverage=schoolsystem_tests_unit_win.cov --export_type=cobertura:schoolsystemapp_unit_win_cobertura.xml --sources src\utility\src --sources src\utility\header --sources src\schoolsystem\src --sources src\schoolsystem\header --sources src\schoolsystemapp\src --sources src\schoolsystemapp\header --sources src\tests\utility --sources src\tests\schoolsystem -- build_win\build\Debug\schoolsystemapp.exe

echo Generate Unit Test Coverage Report
call reportgenerator "-title:Schoolsystem Library Unit Test Coverage Report (Windows)" "-targetdir:docs/coveragereportlibwin" "-reporttypes:Html" "-reports:**/schoolsystemapp_unit_win_cobertura.xml" "-sourcedirs:src/utility/src;src/utility/header;src/schoolsystem/src;src/schoolsystem/header;src/schoolsystemapp/src;src/schoolsystemapp/header;src/tests/utility;src/tests/schoolsystem" "-filefilters:-*minkernel\*;-*gtest*;-*a\_work\*;-*gtest-*;-*gtest.cc;-*gtest.h;-*build*" "-historydir:report_test_hist_win"
call reportgenerator "-targetdir:assets/codecoveragelibwin" "-reporttypes:Badges" "-reports:**/schoolsystemapp_unit_win_cobertura.xml" "-sourcedirs:src/utility/src;src/utility/header;src/schoolsystem/src;src/schoolsystem/header;src/schoolsystemapp/src;src/schoolsystemapp/header;src/tests/utility;src/tests/schoolsystem" "-filefilters:-*minkernel\*;-*gtest*;-*a\_work\*;-*gtest-*;-*gtest.cc;-*gtest.h;-*build*"
...
call robocopy src\schoolsystem\header "build_win\build\Release" /E
call robocopy src\schoolsystemapp\header "build_win\build\Release" /E
...
call robocopy src\schoolsystem\header "build_win\build\Debug" /E
call robocopy src\schoolsystemapp\header "build_win\build\Debug" /E
