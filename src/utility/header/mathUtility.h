...
class MathUtility {
 public:
   ...
   */
  static double schoolsystemsMean(const double fiArray[], int fiArrayLen);
   ...
   */
  static double schoolsystemsMedian(const double fiArray[], int fiArrayLen);
   ...
   */
  static void schoolsystemsMinMax(const double fiArray[], int fiArrayLen, double *foMin, double *foMax);
