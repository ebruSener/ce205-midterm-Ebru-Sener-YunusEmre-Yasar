...
using namespace school::Utility;


double MathUtility::schoolsystemsMean(const double data[], int datalen) {
  double sum = 0.0;
...
double MathUtility::schoolsystemsMedian(const double data[], int datalen) {
...
void MathUtility::schoolsystemsMinMax(const double data[], int datalen, double *min, double *max) {
  *min = data[0];
  *max = data[0];
